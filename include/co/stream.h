...
struct D {
    constexpr D(double v, int n) noexcept : v(v), n(n) {}
    double v;
    int n;
};

constexpr D _1(double v) { return D(v, 1); }
constexpr D _2(double v) { return D(v, 2); }
constexpr D _3(double v) { return D(v, 3); }
constexpr D _4(double v) { return D(v, 4); }
constexpr D _5(double v) { return D(v, 5); }
constexpr D _6(double v) { return D(v, 6); }
constexpr D _7(double v) { return D(v, 7); }
constexpr D _8(double v) { return D(v, 8); }
constexpr D _9(double v) { return D(v, 9); }
constexpr D _10(double v) { return D(v, 10); }
constexpr D _11(double v) { return D(v, 11); }
constexpr D _12(double v) { return D(v, 12); }
constexpr D _13(double v) { return D(v, 13); }
constexpr D _14(double v) { return D(v, 14); }
constexpr D _15(double v) { return D(v, 15); }
constexpr D _16(double v) { return D(v, 16); }
constexpr D _n(double v, int n) { return D(v, n); }
...
protected:
    ...
    stream& operator<<(short v) {
        ...
        _size += co::itoa(v, _p + _size);
        return *this;
    }

    stream& operator<<(unsigned short v) {
        this->ensure(sizeof(v) * 3);
        _size += co::utoa(v, _p + _size);
        return *this;
    }

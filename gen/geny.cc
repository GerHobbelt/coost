...
#line 84 "geny.yy"
	{
        if (g_prog->service()) {
            co::cout("error: found multiple service", co::endl);
...
#line 96 "geny.yy"
	{
        ...
        if (!yyval.tservice->add_method(m)) {
            co::cout("error: method name ", m, " duplicated", co::endl);
            exit(0);
        }
    }
#line 1205 "geny.cc"
...
#line 116 "geny.yy"
	{
        ...
        if (!g_prog->add_object(yyval.tobject)) {
            co::cout("error: object type ", yyval.tobject->name(), " duplicated", co::endl);
...
#line 128 "geny.yy"
	{
        ...
        if (!(yyval.tobject->add_field(yystack.l_mark[0].tfield))) {
            co::cout("error: field ", yystack.l_mark[0].tfield->name(), " duplicated in object ", yyval.tobject->name(), co::endl);
            exit(0);
        }
    }
#line 1243 "geny.cc"
...
#line 165 "geny.yy"
	{
        ...
        if (!yyval.ttype) {
            co::cout("unknown type ", s, " at line ", yylineno, co::endl);
            exit(0);
        }
    }
#line 1293 "geny.cc"
